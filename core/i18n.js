  ...
  constructor() {
    ...
    this.translations = {
      zh: {
        ...
        'settings.autoRestore.title': '阅读进度',
        'settings.autoRestore.label': '自动恢复阅读进度',
        ...
        'settings.data.restoreProgress': '手动恢复进度',
      ...
      en: {
        ...
        'settings.autoRestore.title': 'Reading Progress',
        'settings.autoRestore.label': 'Auto restore reading progress',
        ...
        'settings.data.restoreProgress': 'Restore Progress',
        ...
        'toast.bookmarkAdded': 'This message is already bookmarked',
